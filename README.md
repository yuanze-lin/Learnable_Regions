...
**If you haven't downloaded 'runwayml/stable-diffusion-inpainting' before it was closed, please set `--diffusion_model_path 'stabilityai/stable-diffusion-2-inpainting'`.**
