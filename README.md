...
### Edit Single Image
Run the following command to start training for editing only one single image.
...
Run the following command to start training for editing multiple images simultaneously.
